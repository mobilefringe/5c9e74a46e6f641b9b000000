                            	    ...
                            	    <div class="store_logo_container">
                            	        <router-link :to="'/stores/'+ store.slug">
                                			...
                                			<div v-if="!store.no_store_logo">
                                			    <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5c9e74a46e6f641b9b000000/image/png/1554995111000/miramesa_default.png" alt="Store Logo">
