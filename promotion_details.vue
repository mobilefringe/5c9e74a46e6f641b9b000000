                                ...
                                <div class="row margin_30">
                                    <div class="col-md-12">
                                        <router-link to="/events_and_promotions">
                    		                <div class="animated_btn pull-left">Back to Promotions & Events</div>    
                    		            </router-link>    
                                    </div>
                                </div>
        ...
        //             } else {
					...
					if (this.currentPromo === null || this.currentPromo === undefined) {
					    ...
					    if (this.currentPromo.promotionable_type === "Store"){
                            ...
                            if  (_.includes(this.currentPromo.promo_image_url_abs, 'missing')) {
                                this.currentPromo.image_url = "//codecloud.cdn.speedyrails.net/sites/5dd4301c6e6f640c3a020000/image/png/1554994866000/miramesa_banner.png";    
                            }
                        }
					}
