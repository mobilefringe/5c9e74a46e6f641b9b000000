    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), #61783e url(' + pageBanner.image_url + ') center center' }">
                ...
                this.loadData().then(response => {
                    ...
                    if(temp_repo !== null && temp_repo !== undefined) {
                       ...
                       this.pageBanner = temp_repo[0];
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5dd4301c6e6f640c3a020000/image/png/1554994866000/miramesa_banner.png"
                        }
                    }
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8911)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8907)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8908)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8909)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8910)) {
                        ...
                        _.forEach(this.currentStore.promotions, function(value, key) {
                            ...
                            if (_.includes(current_promo.image_url, 'missing')) {
                                current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5dd4301c6e6f640c3a020000/image/png/1554995111000/miramesa_default.png";
                            }
                        ...
                        _.forEach(this.currentStore.events, function(value, key) {
                            ...
                            if (_.includes(current_event.image_url, 'missing')) {
                                current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5dd4301c6e6f640c3a020000/image/png/1554995111000/miramesa_default.png";
                            }
