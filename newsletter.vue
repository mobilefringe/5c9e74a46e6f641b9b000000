    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)),  #61783e url(' + pageBanner.image_url + ') center center rgb(116,126,92)' }">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/bzujh/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                        ...
                                        <input v-model="form_data.first_name" required class="margin_20 form-control" id="fieldgjidii" name="cm-f-gjidii" type="text" placeholder="First Name">
                                    </div>
                                    <div class="col-sm-6" >
                                        <label for="fieldgjidid" class="accessibility">Last Name</label>
                                        <input v-model="form_data.last_name" required class="margin_20 form-control" id="fieldgjidid" name="cm-f-gjidid" type="text" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="newsletter_email" class="accessibility">Email</label>
                                        <input v-model="form_data.email" required class="margin_20 form-control" name="cm-bzujh-bzujh" type="email" placeholder="Email" id="newsletter_email">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
    ...
    define(["Vue", "vuex", "jquery", "vee-validate", "json!site.json"], function(Vue, Vuex, $, VeeValidate, site) {
        ...
        return Vue.component("newsletter-component", {
            ...
            mounted () {
                ...
                $("#fieldgjidii").val(this.form_data.first_name);
